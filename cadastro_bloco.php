...
<br>
	...
	?>
				...
				<textarea class="formCampo" name="bdescricao" cols="80" rows="10" required="yes" placeholder="Descrição"></textarea><br><br>
...
//INSERINDO BLOCO
		...
		if(isset($_POST['btCadastra_bloco']) and isset($_FILES['imgss'])){
			...
			$fotoCerragada = false;
				...
				@require "connect.php";
								$sql = $_con->query("insert into blocos(id,titulo,descricao,img)
